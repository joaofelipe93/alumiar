      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="bg-ink p-8 md:p-12">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2">
            <div className="bg-white/5 p-8 md:row-span-2">
              <h2 className="text-3xl font-extrabold uppercase leading-[0.95] tracking-tight text-white md:text-4xl">
              ...
              <Link
                to="/contato"
                className="mt-8 inline-flex items-center gap-2 bg-white px-6 py-3 text-xs font-bold tracking-widest text-ink transition hover:bg-brand-500 hover:text-white"
              >
            ...
            <div className="bg-white/5 p-6">
              ...
              <h3 className="mt-6 text-xs font-bold uppercase tracking-widest text-white">
